...
export function getPixelVals<FacValue, FacType, Adm1Value, Adm2Value>(
...
): PixelVals<FacValue, FacType, Adm1Value, Adm2Value> {
  const hasAdm1Number =
  ...
  const hasAdm2Number =
    data.adm2 && data.adm2.pixAdm2Number[iPixInOriginal] !== 0;
  ...
  return {
    ...
    adm2Index,
    adm2Value:
      adm2Index !== undefined ? data.adm2?.adm2Values?.[adm2Index] : undefined,
  };
}
